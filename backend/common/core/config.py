...
class Settings(BaseSettings):
    ...
    LOCAL_MODEL_PATH: str = 'D:\\codes\MySQLBot\\backend\\models'
    ...
    EMBEDDING_METRIC_SIMILARITY: float = 0.7  # 指标元数据向量相似度阈值
    ...
    EMBEDDING_METRIC_TOP_COUNT: int = EMBEDDING_DEFAULT_TOP_COUNT  # 指标元数据向量搜索返回数量
